<template>
  <el-dialog :model-value="isVisible" title="添加成员" style="width: 30%" @close="onClose">
    <el-form ref="peopleFormRef" :model="formPeopleData" :rules="peopleRules" class="demo-formPeopleData">
      <el-form-item prop="userName" label="输入用户" :label-width="formLabelWidth" :validate-on-rule-change="false">
        <SearchDropInput v-if="isVisible" v-model:value="formPeopleData.userId" v-model:text="formPeopleData.userName" />
      </el-form-item>
