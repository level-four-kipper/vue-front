    ...
    <div class="tabs">
      ...
      <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick" @tab-change="tabChange">
        <el-tab-pane label="全部" name="3">
          <TestTable :tableData="tableData" :loading="loading" :deleteQuestion="deleteQuestion" :total="total" @sizeChange="getsizeChange" @currentChange="getcurrentChange" />
        </el-tab-pane>
...
import { fetchQuestion,fetchDeleteQuestion } from '@/api/questionBank.js'
